    ...
    <footer data-print-hidden="true" className="mx-auto max-w-[1760px] px-2 pb-5 pt-1 text-center text-xs text-[var(--text-secondary)] sm:px-5 lg:px-6">
      <p className="border-t border-[var(--border-subtle)] pt-3">
        ...
        <a
          ...
          className="font-semibold text-[var(--brand-primary)] underline underline-offset-2 hover:opacity-80 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--brand-primary)] focus-visible:ring-offset-1"
        >
