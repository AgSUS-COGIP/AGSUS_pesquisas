...
// A versão na URL invalida favicons e imagens institucionais que navegadores
// mantêm em cache por muito tempo, mesmo depois de o arquivo ser atualizado.
export const OFFICIAL_PLATFORM_LOGO_URL = "/agsus-logo.png?v=20260824";
