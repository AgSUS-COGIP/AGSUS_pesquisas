...
revoke all on function sigav.fc_listar_dimensoes_publico(jsonb) from public;
revoke all on function sigav.fc_buscar_pessoas_publico(text, integer, jsonb) from public;
