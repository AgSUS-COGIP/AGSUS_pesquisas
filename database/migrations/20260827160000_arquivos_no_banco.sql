-- ============================================================================
-- Arquivos de imagem no banco, no lugar do Storage do PostgreSQL
-- ============================================================================
--
...
-- um domínio do PostgreSQL. Agora os bytes saem da própria origem da aplicação,
...
comment on table sigav.tb_arquivo is
  'Imagens da plataforma (marca e capas de pesquisa), no lugar dos buckets do PostgreSQL Storage. Servidas por /api/arquivos.';
