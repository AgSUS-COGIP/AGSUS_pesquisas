...
--
-- POR QUE NÃO É pgTAP. Os testes pgTAP rodam por `supabase test db`, sobre um
-- banco que o `supabase db reset` reconstrói a partir de `migrations/`. Esse
...
-- `supabase_auth_admin`), e — o que causou o defeito daquele dia — não contém
