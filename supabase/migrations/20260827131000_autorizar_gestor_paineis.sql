...
-- As duas RPCs abaixo são somente de leitura do módulo Painéis. O modelo de
-- permissões por módulo já concede DASHBOARDS a SuperAdmin, Admin e Gestor.
-- Não ampliar can_manage_surveys(): essa capacidade continua reservada à
